...
function IdMessage() {
    ...
    React.useEffect(() => {
        fetch(`https://messaging-app-backend-miwr.onrender.com/api/messages/${messageId}`)
            .then(res => res.json())
    ...
    function handleSubmit(e) { //only works for author?
        ...
        fetch(`https://messaging-app-backend-miwr.onrender.com/api/messages/${messageId}/send-message`, fetchParams)
            .then(res => res.json())
