...
function Messages() {
    ...
    React.useEffect(() => {
        ...
        fetch("https://messaging-app-backend-miwr.onrender.com/api/messages/all")
            .then(res => res.json())
    ...
    React.useEffect(() => {
        currentUser && fetch(`https://messaging-app-backend-miwr.onrender.com/api/messages/user/${currentUser.id}`)
            .then(res => res.json())
    ...
    function openUser(id) {
        ...
        if (messageExists) { navigate(`/message/${postId}`) }
            ...
            fetch("https://messaging-app-backend-miwr.onrender.com/api/messages/create", { method: 'POST', headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: id }) })
                .then(res => res.json())
